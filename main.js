...
// const traffic = [
//     new Car(road.getLaneCenter(Math.round(Math.random()*2)),-100,30,50,"DUMMY",2,getRandomColor()),
//     new Car(road.getLaneCenter(Math.round(Math.random()*2)),-300,30,50,"DUMMY",2,getRandomColor()),
//     new Car(road.getLaneCenter(Math.round(Math.random()*2)),-300,30,50,"DUMMY",2,getRandomColor()),
//     new Car(road.getLaneCenter(Math.round(Math.random()*2)),-500,30,50,"DUMMY",2,getRandomColor()),
//     new Car(road.getLaneCenter(Math.round(Math.random()*2)),-500,30,50,"DUMMY",2,getRandomColor()),
//     new Car(road.getLaneCenter(Math.round(Math.random()*2)),-700,30,50,"DUMMY",2,getRandomColor()),
//     new Car(road.getLaneCenter(Math.round(Math.random()*2)),-700,30,50,"DUMMY",2,getRandomColor()),
...
function animate(time){
    for(let i=0;i<traffic.dumbcars.length;i++){
        traffic.dumbcars[i].update(road,[]);
    }
    for(let i=0;i<cars.length;i++){
        cars[i].update(road,traffic.dumbcars);
    }
    bestCar=cars.find(
        c=>c.y==Math.min(
            ...cars.map(c=>c.y)
    ...
    road.draw(carCtx);
    for(let i=0;i<traffic.dumbcars.length;i++){
        traffic.dumbcars[i].draw(carCtx);
    }
